...
#define VT100RESET "\x1bc"                  // Reset device
#define VT100RESETATTR "\x1b0m"             // Reset all display attributes (color, blink, hidden, reverse, underscore,...)
...
#define VT100SCROLLUP "\x1bM"               // Scroll display up one line.

#define VT100CURSORSAVE "\x1b7" // Save cursor and attributes
#define VT100CURSORRESTORE "\x1b8" // Restore cursor and attributes
